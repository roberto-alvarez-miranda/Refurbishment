...
- [x] Task: Create `CypeParameterPopup.tsx` React component.
    - [x] Write Playwright tests verifying Popup modal rendering and CYPE code assembly (Red Phase).
    - [x] Implement Popup modal in React with CYPE-compliant dropdowns (wall thickness, method, disposal).
- [x] Task: Integrate Gemini 3.1 Pro + Google Search Grounding for material specs.
    ...
    - [x] Wire up the "AI Material Specifier" search bar inside the Popup Modal to fetch structured live prices and links.
- [x] Task: Conductor - User Manual Verification 'Phase 2: Frontend \"Zoom\" Quality Selector Popup Modal' (Protocol in workflow.md)
